    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publicContact', models.EmailField(max_length=254)),
                ('mailingList', models.EmailField(max_length=254)),
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('theme', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='MMUX.Theme')),
            ],
        ),
    ]
